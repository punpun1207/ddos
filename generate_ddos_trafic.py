...
def startNetwork():
    ...
    print("--------------------------------------------------------------------------------")   
    src.cmd("timeout 60s hping3 -1 -V -d 120 -w 64 -p 80 --rand-source --flood {}".format(dst))  
    sleep(30)
    ...
    print("--------------------------------------------------------------------------------")   
    src.cmd("timeout 60s hping3 -2 -V -d 120 -w 64 --rand-source --flood {}".format(dst))    
    sleep(30)
    ...
    print("--------------------------------------------------------------------------------")
    #src.cmd('timeout 6s hping3 -S -V -d 120 -w 64 -p 80 --rand-source --flood 10.0.0.1')
    src.cmd("timeout 60s hping3 -S -V -d 120 -w 64 -p 80 --rand-source --flood {}".format(dst))
    sleep(30)
